...
This PR ships the feature **into the existing Agent22 page** (`rooms/agent22/html/`). The follow-on PxD consolidation ([PR_PXD_GAME_DASHBOARD_FRAMEWORK.md](PR_PXD_GAME_DASHBOARD_FRAMEWORK.md)) absorbs the loader unchanged.
